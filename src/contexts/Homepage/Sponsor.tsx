    ...
    <div>
      <div className='h-auto'>
        ...
        <div className='flex xl:mt-[70px] mt-[10px] sm:mt-[20px] md:mt-[30px] lg:mt-[50px]'>
              <div className='relative w-1/3 flex flex-col xl:ml-[200px] ml-[20px] sm:ml-[50px] md:ml-[100px] lg:ml-[150px]'>
                  <Image src = {formula}/>
              </div>
              <div className='relative w-1/3 flex flex-col xl:mx-[100px] mx-[10px] sm:mx-[25px] md:mx-[50px] lg:mx-[75px]'>
                  <Image src = {fullo}/>
              </div>
              <div className='relative w-1/3 flex flex-col xl:mr-[200px] mr-[20px] sm:mr-[50px] md:mr-[100px] lg:mr-[150px]'>
                  <Image src = {macito}/>
              </div>
            </div>
        ...
        <div className="relative items-center overflow-hidden">         
          ...
          <div className='absolute top-0'>
            <div className= 'flex flex-col font-[Excalibur-Nouveau] text-center text-white text-[40px] mt-[50px]'>
              MEDIA PARTNERS
            </div>
            <div className='flex xl:mt-[70px] mt-[10px] sm:mt-[20px] md:mt-[30px] lg:mt-[50px]'>
              <div className='relative w-1/3 flex flex-col xl:ml-[200px] ml-[20px] sm:ml-[50px] md:ml-[100px] lg:ml-[150px]'>
