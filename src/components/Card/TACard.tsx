    ...
    <div>
      <div className="flex flex-col items-center justify-center w-[306px] h-[502px]" style={{ fontFamily: 'Heavy-Heap', color: '#FFE8C3' }}>
        <div className="bg-no-repeat bg-center text-center w-[306px] h-[502px]" style={{ backgroundImage: `url(${bg.src})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', filter: 'drop-shadow(5px 10px 7px rgba(255,255,0, 0.25))' }}>
          <h1 className="text-2xl font-normal tracking-widest mt-5" style={{ filter: 'drop-shadow(0px 5px 5px rgba(0, 0, 0, 0.25))' }}>{name}</h1>
          <h2 className="text-1xl  font-thin tracking-widest mb-8" style={{ filter: 'drop-shadow(0px 5px 5px rgba(0, 0, 0, 0.25))' }}>{nim} - {prodi}</h2>
          ...
          <h2 className="text-4xl font-normal leading-10 tracking-wider mb-4 tracking-0.1 mt-5" style={{ filter: 'drop-shadow(0px 5px 5px rgba(0, 0, 0, 0.25))' }} >{title}</h2>
          <div className="cardButton flex justify-center items-center mt-12" style={{ filter: 'drop-shadow(0px 5px 5px rgba(0, 0, 0, 0.25))' }}>
            <BlueButton />
          </div>
        </div>
      </div>
