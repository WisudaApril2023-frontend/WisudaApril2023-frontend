...
const Instagram_button = (): JSX.Element => {
  return (
...
const Twitter_button = (): JSX.Element => {
  return (
...
const Youtube_button = (): JSX.Element => {
  return (
...
const Linkedin_button = (): JSX.Element => {
  return (
...
const Tiktok_button = (): JSX.Element => {
  return (
    ...
    <nav>
      <div className="absolute bottom-0 bg-[#ECA829] w-full filter pl-0 pr-2.5 py-1 h-10 sm:h-14 lg:h-16 xl:h-20 items-center border-solid border-1 border-black flex justify-between">
        <div className='ml-2 xl:ml-5 pl-1'>
          ...
          <div className='ml-2.5 lg:ml-4'><Text_footer /></div>
        </div>
        <div className='flex items-center mr-2 md:mr-4 xl:mr-7'>
          <div className='ml-2.5 sm:ml-5 lg:ml-7 xl:ml-9'><Instagram_button /></div>
          <div className='ml-2.5 sm:ml-5 lg:ml-7 xl:ml-9'><Twitter_button /></div>
          <div className='ml-2.5 sm:ml-5 lg:ml-7 xl:ml-9'><Youtube_button /></div>
          <div className='ml-2.5 sm:ml-5 lg:ml-7 xl:ml-9'><Linkedin_button /></div>
          <div className='ml-2.5 sm:ml-5 lg:ml-7 xl:ml-9'><Tiktok_button /></div>
        </div>
      </div>
    </nav>
  )
